...
import { Activity, Users, LogOut, Plus, Calendar, TrendingUp } from 'lucide-react'
...
export default function TherapistDashboard() {
  const { user, loading, logout, isTherapist } = useAuth()
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-sm text-gray-500">Panou kinetoterapeut</span>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">Gestionați pacienții și planurile de recuperare</p>
        </div>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Button onClick={() => router.push('/therapist/pacienti/new')}>
              ...
              <div className="space-y-4">
                {patients.slice(0, 5).map((patient) => (
                  <div key={patient.id} className="flex items-center justify-between p-4 border rounded-lg">
                    ...
                    <Button 
                      variant="outline" 
                      size="sm"
                      onClick={() => router.push(`/therapist/pacienti/${patient.id}`)}
                    >
                      Vezi Detalii
                    </Button>
                  </div>
                ...
                {patients.length > 5 && (
                  <div className="text-center pt-4">
                    <Button variant="outline" onClick={() => router.push('/therapist/pacienti')}>

        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-sm text-gray-500">Pacienți</span>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600 mt-2">Gestionați pacienții dumneavoastră</p>
          </div>
              ...
              <Card key={patient.id} className="hover:shadow-lg transition-shadow cursor-pointer">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex space-x-2">
                    ...
                    <Button 
                      size="sm"
                      onClick={() => router.push(`/therapist/pacienti/${patient.id}/plan`)}
                      className="flex-1"
                    >
                      Plan Recuperare
                    </Button>
